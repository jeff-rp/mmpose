...
from .coord_cls_heads import RTMCCHead, RTMWHead, SimCCHead, EVitCCHead
from .heatmap_heads import (AssociativeEmbeddingHead, CIDHead, CPMHead,
                            HeatmapHead, InternetHead, MSPNHead, ViPNASHead, FFHead)
...
__all__ = [
    ...
    'InternetHead', 'RTMWHead', 'RTMOHead', 'FFHead', 'EVitCCHead'
]
