...
num_workers = 6
val_interval = 1
cos_annealing_begin = 0
data_root = '../'
# backbone_checkpoint = 'https://download.openmmlab.com/mmclassification/v0/mobileone/'\
#                       'mobileone-s3_8xb32_in1k_20221110-c95eb3bf.pth'
backbone_checkpoint = 'work_dirs/td-hm_mobileone-s3_ffb-192x192/best_AUC_epoch_4.pth'
head_checkpoint = 'work_dirs/td-hm_mobileone-s3_ffb-192x192/best_AUC_epoch_4.pth'
